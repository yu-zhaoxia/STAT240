...
https://yu-zhaoxia.github.io/STAT240/
...
- Multivariate data: the data with <span style="color:red">simultaneous
measurements</span> on many variables
...
- What is the distance between (-2,0) and (2,0)? <span style="color:red">4</span>.
- What is the distance between (0, -2) and (0,2)? <span style="color:green">4</span>.
```{r, out.width="80%", echo=FALSE,  fig.align="center"}
set.seed(20230404)
par(pty="s")
mvrnorm(n=1000, c(0,0), matrix(c(4,0,0,1),2,2)) %>% 
